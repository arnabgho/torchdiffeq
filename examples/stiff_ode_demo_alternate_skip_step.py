...
if args.adjoint:
    ...
    from torchdiffeq import odeint_skip_step
...
if args.viz:
    makedirs('png_alternate_skip_step')
...
def visualize(true_y, pred_y, pred_ys, odefunc, itr):
    ...
    if args.viz:
        ...
        fig.tight_layout()
        plt.savefig('png_alternate_skip_step/{:04d}'.format(itr))
        plt.draw()
        plt.pause(0.001)
...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        pred_y = odeint_skip_step(func, batch_y0, batch_t,num_skips=args.num_skips,skip_proportion=args.skip_proportion)
        ...
        if itr % args.test_freq == 0:
            with torch.no_grad():
                ...
                for i in range(args.ntest):
                    pred_ys.append(odeint_skip_step(func,true_y0,t,num_skips=args.num_skips,skip_proportion=args.skip_proportion))
